...
import { LayoutDashboard, ListTree, List, Settings, Trash2, Copy, Code, Monitor, Bot, HardDrive, Home, FolderOpen, LockKeyhole } from 'lucide-react'
  ...
  return (
    <div className="flex h-screen bg-black text-white font-sans overflow-hidden">
      ...
      <main className="flex-1 flex flex-col relative z-10 h-full overflow-hidden">
        ...
        />
        <button onClick={onUpgrade} className={`absolute right-8 top-3 z-30 rounded-full border px-4 py-1.5 text-xs font-bold shadow-lg transition-colors ${isPro ? 'border-emerald-400/30 bg-emerald-400/10 text-emerald-300' : 'border-primary/40 bg-primary/15 text-primary hover:bg-primary/25'}`}>
